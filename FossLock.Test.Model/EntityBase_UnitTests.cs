...
using FossLock.Test.Model.Helpers;
...
{
    [TestFixture]
    public class EntityBase_UnitTests
    {
        ...
        public void CanSerializeEntityToJson()
        {
            ...
            StringAssert.Contains("serialize@this.net", result);
            // result.ShouldContain("serialize@this.net"); .. not sure where this extension method was supposed to load from.
        }
        ...
        public class ObjectWithOneDomainSignatureProperty : EntityBase
        {
            [DomainSignature]
        ...
        private class AddressBeingDomainSignatureComparble : EntityBase
        {
            [DomainSignature]
        ...
        private class Object1 : EntityBase
        {
        }

        private class Object2 : EntityBase
        {
        }

        private class ObjectWithAllDomainSignatureProperty : EntityBase
        {
            [DomainSignature]
            public int Age { get; set; }
        ...
        private class ObjectWithComplexProperties : EntityBase
        {
            [DomainSignature]
        ...
        private class ObjectWithIdenticalTypedProperties : EntityBase
        {
            [DomainSignature]
            public string Address { get; set; }
        ...
        private class ObjectWithIntId : EntityBase
        {
            [DomainSignature]
            public string Name { get; set; }
        }
        ...
        /// </summary>
        private class ObjectWithNoDomainSignatureProperties : EntityBase
        {
            public int Age { get; set; }
        ...
        private class Contact : EntityBase
        {
