...
namespace FossLock.Test.Model
{
    [TestFixture]
    public class BaseObjectEqualityComparer_UnitTests
    {
        [Test]
        ...
        {
            var comparer = new BaseObjectEqualityComparer<EntityBase>();
        ...
        private class ConcreteEntityWithDomainSignatureProperties : EntityBase
        {
            [DomainSignature]
            public string Name { get; set; }
        }

        private class ConcreteEntityWithNoDomainSignatureProperties : EntityBase
        {
            public string Name { get; set; }
        }
