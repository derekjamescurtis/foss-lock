...
namespace FossLock.Model
{
    ...
    {
        /// <summary>
        /// Represents the primary key field in the database.
        /// </summary>
        public int Id { get; set; }

        /// <summary>
        /// A short amount of text that identifies this product to users.
        /// </summary>
        ...
        /// <summary>
        /// Flag enum that indicates the hardware lock properties that will be required by default for activation. This may be overridden on an individual license.
        /// </summary>
        public LockPropertyType DefaultLockProperties { get; set; }

        /// <summary>
        /// Indicates whether licensing should fail if any of the required hardware identifiers cannot be read.
        /// </summary>
        ...
        /// <summary>
        /// Indicates how strict the system will be when activating.  <see cref="FossLock.Core.VersionLeewayType"/> has additional details.
        /// </summary>
        public VersionLeewayType VersionLeeway { get; set; }

        /// <summary>
        /// Optional collection of features that may be licensed in addition to the main product license.
        /// </summary>
        public virtual ICollection<ProductFeature> AvailableFeatures { get; set; }
        
        /// <summary>
        /// A collection of versions of this product, which are actually the objects licensed out to customers.
        /// </summary>
